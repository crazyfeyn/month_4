...
import 'package:flutter_application/views/screens/product_ready_to_buy_screen.dart';
import 'package:flutter_application/views/widgets/cart_widget.dart';
...
class _CategoryScreenState extends State<CategoryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    productBox.clear();
    for (var element in productController.productList) {
